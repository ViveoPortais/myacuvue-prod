      ...
      renderCell: (params: any) => (
        <div className={`w-full`}>
          <ButtonViewMore
            ...
            disableHover
            label="Ver mais"
            customClass="bg-careDarkBlue border-careDarkBlue w-full md:w-28 py-2 text-sm"
          />
        </div>
      ),
    },
      ...
      renderCell: (params: any) => (
        <div>
          <ButtonAttendanceCancel
            id="button-attendance-cancel"
            params={params.row.visitId}
            disableHover
            label="Cancelar"
            customClass="bg-white border-careDarkBlue text-careDarkBlue w-full md:w-32 py-2 text-sm"
          />
        </div>
      ),
    },
      ...
      renderCell: (params: any) => (
        <div>
          <ButtonAttendanceConfirmation
            id="button-attendance-confirmation"
            params={params}
            disableHover
          />
        </div>
