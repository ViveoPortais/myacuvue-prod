...
const ButtonRescueVoucher = ({
  ...
  return (
    <button
      ...
      disabled={disabled}
      className={`relative disabled:bg-gray-500 disabled:border-gray-500 disabled:opacity-70  border-2 z-0 text-[11px] md:text-sm disabled:cursor-not-allowed rounded-lg  transition ${
