...
const OrderPurchase = () => {
  ...
  }, [dataScheduling.refresh, startDate, status, partnerQuery, type,dataScheduling.dataFilter]);
  ...
  const handleClientTable = () => {
    ...
    listPartinerAdmin()
      .then((res) => {
        ...
        if (partnerQuery) {
          const normalizedQuery = normalizeCnpj(partnerQuery.toLowerCase());
          ...
          filteredData = filteredData.filter((item: any) => {
            return (
              ...
              normalizeCnpj(item.partnerCnpj).includes(normalizedQuery) ||
  ...
  const handleStattDateCHange = (e: any) => {
    const value = e.target.value;
    setStartDate(value);
    dataScheduling.setDataFilter(value);
  };
    ...
    <div className="fade-in mb-5">
      ...
      <div className="w-full mt-10 md:grid md:grid-cols-4 flex flex-col gap-5">
        <div className="flex flex-col">
          ...
          <Input
            id="input-pesquisa-localizar-por"
            value={startDate}
            onChange={handleStattDateCHange}
        ...
        <div className="flex flex-col">
          ...
          <CustomSelect
            id="input-pesquisa-localizar-status"
            options={[
        ...
        <div className="flex flex-col">
          ...
          <Input
            id="input-pesquisa-localizar-parceiros"
        ...
        <div className="flex flex-col">
          ...
          <CustomSelect
            id="input-pesquisa-localizar-tipo"
            options={[
      ...
      <div className="lg:flex lg:flex-row lg:justify-end md:flex md:flex-row md:justify-end flex flex-col gap-4 md:mt-20 mt-10">
        <div>
          <Button
            id="button-pedido-compra-limpar"
        ...
        <div>
          <Button
            id="button-pedido-compra-iniciar"
      ...
      {openTable && (
        <>
          ...
          <div className="md:flex md:justify-end lg:flex lg:justify-end flex justify-center mt-5 mb-10 gap-2 fade-in">
            <div>
              <ExportToTxtAll
                id="button-pedido-compra-baixar-todos"
                label="Baixar Todos"
