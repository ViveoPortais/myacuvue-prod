...
const DashboardAdmin = () => {
  ...
  const [diableCheckbox, setDisableCheckbox] = useState(false);
  ...
  const getAllPatients = () => {
    ...
    getListAllPatients()
      .then((response) => {
        const mapId = response.map((item: any) => {
          return {
            ...item,
            id: item.id,
          };
        ...
        console.log(response.map((item: any) => item.createdOn));

        const sortedPatients = mapId.sort((a: any, b: any) => {
      ...
      <div className="w-full fade-in">
        <div className=" md:grid md:grid-cols-4 rounded-lg">
          ...
          <div className="mt-2 md:ml-10 mb-2">
            <ExportToCSV
              id="export-to-csv-dashboard-admin"
              rows={patientList}
        ...
        <div className="md:grid md:grid-cols-1 gap-8 my-2 fill-careBlue mt-10">
          <div>
            ...
            <div className="sm:grid-cols-1 md:grid md:grid-cols-4 gap-6">
              <CustomSelect
                id="voucher-types-select-dashboard-admin"
                fullWidth
              ...
              />
              <CustomSelect
                id="voucher-status-select-dashboard-admin"
                fullWidth
              ...
              />
              <CustomSelect
                id="voucher-period-select-dashboard-admin"
                fullWidth
              ...
              <div className="flex items-center">
                <Checkbox
                  id="checkbox-all-vouchers-dashboard-admin"
        ...
        <div className="md:grid md:grid-cols-1 my-2  fill-careBlue mt-5">
          <div>
            ...
            <div className=" mb-8 md:mb-0 sm:grid-cols-1 md:grid md:grid-cols-3 gap-6">
              ...
              <div>
                <CustomSelect
                  id="select-status-voucher-client-dashboard-admin"
                  name=""
                  options={[
                    { id: "", value: "Todos" },
              ...
              <div className="flex items-center">
                <Checkbox
                  id="checkbox-all-patients-dashboard-admin"
                  icon={<RadioButtonUncheckedIcon />}
                  checkedIcon={<RadioButtonCheckedIcon />}
          ...
          <div className="mt-5">
            ...
            <div className="fill-careBlue md:fill-careBlue mb-5 sm:grid-cols-1 md:grid md:grid-cols-3 gap-6">
              <div className="col-span-2">
                <Input
                  id="input-search-partiner-dashboard-admin"
                  value={filterValue}
              ...
              <div className="flex items-center">
                <Checkbox
                  id="checkbox-all-partiners-dashboard-admin"
                  icon={<RadioButtonUncheckedIcon />}
                  checkedIcon={<RadioButtonCheckedIcon />}
            ...
            <div className="flex justify-start gap-2 mt-10 mb-10">
              <div>
                <Button
                  id="button-clean-inputs-and-checkboxes-dashboard-admin"
              ...
              <div>
                <Button
                  id="button-start-timeline-dashboard-admin"
