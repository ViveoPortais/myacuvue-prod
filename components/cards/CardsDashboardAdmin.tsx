    ...
    <div className="flex flex-col md:flex md:flex-row gap-7 fade-in">
      <div className="w-full h-32 border border-careGreen rounded-2xl ">
        ...
        <div className="flex justify-between px-6">
          ...
          <span
            id="ver-detalhes-resgatados-dashboard-admin"
      ...
      <div className="w-full h-32  border border-careOrange rounded-2xl">
        ...
        <div className="flex justify-between px-6">
          ...
          <span
            id="ver-detalhes-utilizados-dashboard-admin"
            onClick={openModalSeeMoreVouchers.onOpen}
            className="text-xs text-careLightBlue underline mt-6 cursor-pointer"
          >
            Ver detalhes
      ...
      <div className="w-full h-32 border border-careYellow rounded-2xl">
        ...
        <div className="flex justify-between px-6">
          ...
          <span
            id="ver-detalhes-a-resgatar-dashboard-admin"
            onClick={openModalSeeMoreVouchers.onOpen}
            className="text-xs text-careLightBlue underline mt-6 cursor-pointer"
          >
            Ver detalhes
      ...
      <div className="w-full h-32 border border-carePurple rounded-2xl">
        ...
        <div className="flex justify-between px-6">
          ...
          <span
            id="ver-detalhes-expirados-dashboard-admin"
            onClick={openModalSeeMoreVouchers.onOpen}
            className="text-xs text-careLightBlue underline mt-6 cursor-pointer"
          >
            Ver detalhes
