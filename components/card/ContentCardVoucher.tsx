...
const ContentCardVoucher = ({
  ...
  return (
    <div
      className={`w-full rounded-xl lg:h-52 2xl:h-56 ${
        isCustomBg
    ...
    >
      <div
        className={`${isCustomBg && "scale-x-[-1]"} flex flex-col h-full p-2`}
      >
        <div className="text-white md:w-full  2xl:ml-5 mt-5 md:mt-8 xl:mt-4 text-3xl flex flex-col">
          <span className="w-full">{title}</span>
          <span className="text-sm mt-2 ml-1 opacity-95 w-[90%]">
            {subtitle}
          </span>
...
export default ContentCardVoucher;
